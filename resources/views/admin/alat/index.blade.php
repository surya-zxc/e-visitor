...
@section('content')
<h6 class="c-grey-900">
    {{ trans('cruds.alat.title_singular') }} {{ trans('global.list') }}
</h6>
<div class="mT-30">
    @can('alat_create')
    ...
    <div class="table-responsive">
        <table class=" table table-bordered table-striped table-hover datatable datatable-User">
            ...
            <tr>
                ...
                <th>
                    {{ trans('cruds.alat.fields.created_at') }}
                </th>
                <th>
                    {{ trans('cruds.alat.fields.updated_at') }}
                </th>
                <th>
                    {{ trans('cruds.alat.fields.deleted_at') }}
                </th>
                <th>
                    &nbsp;
                </th>
